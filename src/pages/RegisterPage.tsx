...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-surface-950 flex flex-col justify-center items-center p-4 sm:p-6 lg:p-8 relative overflow-hidden text-slate-100 font-sans">
      {/* Background elements */}
      <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-blue-900/20 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-96 h-96 bg-teal-900/20 rounded-full blur-3xl pointer-events-none"></div>
      ...
      >
        ...
        <div className="bg-surface-900 border border-surface-800 rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-slate-400 text-center mb-8">Join Save Shield to stay protected anywhere</p>
